...
export class LocalStorageService {
    ...
    static getCards(): ICard[] {
        const savedCards = JSON.parse(localStorage.getItem('cards') || '[]') as ICard[];
        return savedCards;
    }
    ...
    static getColumns(): IColumn[] {
        ...
        const savedColumns = JSON.parse(localStorage.getItem('columns') || JSON.stringify(defaultColumns)) as IColumn[];
